...
*Note 2: React component lifecycle events is **only available** in class components. This topic is added only to provide a brief overview on how react works under the hood.*
